-- Update existing reactions tables to match Figma "Feeling Container" design
-- Run this script in your Supabase SQL Editor

-- STEP 1: Drop existing policies from old tables (if they exist)
...
-- STEP 3: Recreate post_reactions with Figma feeling types
...
-- STEP 4: Recreate comment_reactions with Figma feeling types
...
-- STEP 7: Create RLS policies (fresh tables, no IF EXISTS needed)
