  ...
  return (
    <div className="mr-[-12px] relative shrink-0 size-[40px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="Icon">
          <path d={svgPaths.p3cb5b100} fill="url(#paint0_linear_1_2228)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_2228" x1="20" x2="20" y1="5" y2="35.5833">
...
function FactualNumbers() {
  return (
    <div className="flex flex-col gap-px items-center justify-center relative shrink-0 w-full" data-name="Factual numbers">
      <InformationFrame />
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white h-[43px] relative rounded-[15px] shadow-elevation shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="box-border flex gap-2 h-[43px] items-center px-6 py-2 relative w-full">
...
function OnboardingOption() {
  return (
    <div className="absolute flex flex-col gap-6 items-start left-[calc(100%+130px)] top-[calc(75%+952.75px)] w-[214px]" data-name="Onboarding option">
      <FactualNumbers />
      <Button />
    </div>
  );
...
function Quotes() {
  return (
    <div className="flex gap-[2px] items-center relative shrink-0" data-name="Quotes">
      <div className="bg-clip-text bg-gradient-to-b flex flex-col text-body-lg from-[#69b57c] justify-center leading-[0] relative shrink-0 text-nowrap to-[#388896]">
...
function Footer() {
  return (
    <div className="absolute bg-variation bottom-px box-border flex flex-col gap-[10px] h-[100px] items-start left-[2px] pb-[39px] pt-[36px] px-[27px] w-[1280px]" data-name="Footer">
      <SarathiCoIn />
    </div>
  );
}
...
function CategoryCard2() {
  return (
    <div className="absolute bg-gradient-to-b bottom-0 box-border flex flex-col from-[#69b57c] items-start left-0 px-[24.321px] py-[18.241px] right-0 rounded-tl-[30.402px] rounded-tr-[30.402px] to-[#388896] top-[59.95%]" data-name="Category card">
      <CategoryCard1 />
    </div>
  );
}
...
function BelowKneeCard() {
  return (
    <div className="h-[244px] overflow-clip relative rounded-[30px] shrink-0 w-[624px]" data-name="below knee card">
      <Group5 />
      <div className="absolute flex flex-col text-h3 inset-[81.56%_-2.56%_5.33%_84.61%] justify-center leading-[0] opacity-0 text-nowrap text-right text-white">
...
function AboveKneeCard() {
  return (
    <div className="h-[244px] overflow-clip relative rounded-[30px] shrink-0 w-[624px]" data-name="Above knee card">
      <Group6 />
      <div className="absolute flex flex-col text-h3 inset-[81.56%_-2.56%_5.33%_84.3%] justify-center leading-[0] opacity-0 text-nowrap text-right text-white">
...
function KneeCards() {
  return (
    <div className="[grid-area:1_/_1] box-border flex gap-[22px] items-center ml-0 mt-0 overflow-x-auto overflow-y-clip relative w-[1120px]" data-name="Knee cards">
      <BelowKneeCard />
      <AboveKneeCard />
      <WheelchairCard />
    </div>
...
function ProsthesisCategory1() {
  return (
    <div className="absolute flex flex-col gap-[46px] items-center leading-[0] left-[calc(50%+0.5px)] top-[calc(25%+511.969px)] translate-x-[-50%] w-[1121px]" data-name="Prosthesis Category">
      <ProsthesisCategory />
      <CategoryCarousel />
    </div>
  );
...
function ClosingContent() {
  return (
    <div className="absolute flex flex-col gap-3 items-center left-1/2 top-[calc(75%+955.469px)] translate-x-[-50%] w-[864px]" data-name="Closing content">
    ...
    <div className="absolute h-[17px] left-[calc(41.667%+80.667px)] top-[582.92px] w-[70px]" data-name="scroll">
      <div className="absolute bottom-[-50%] left-[-14.29%] right-0 top-[-50%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 34">
          <g id="scroll">
            <g filter="url(#filter0_d_1_2259)" id="Ellipse 10">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="34" id="filter0_d_1_2259" width="34" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_2259" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_2259" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function HeroSection() {
  return (
    <div className="absolute contents left-0 top-0" data-name="Hero Section">
      <ImageSection />
      <Scroll />
      <div className="absolute capitalize flex flex-col font-['Roboto:SemiBold',_sans-serif] font-semibold justify-center leading-[0] left-[62px] text-heading text-[0px] top-[729px] translate-y-[-50%] w-[1012px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <p className="leading-[66px] text-[64px]">
          <span className="text-heading" style={{ fontVariationSettings: "'wdth' 100" }}>
            Redefining
          </span>
          <span style={{ fontVariationSettings: "'wdth' 100" }}> </span>
          <span className="bg-clip-text bg-gradient-brand" style={{ WebkitTextFillColor: "transparent", fontVariationSettings: "'wdth' 100" }}>
...
function StoryContent() {
  return (
    <div className="absolute flex flex-col items-start left-[calc(50%-0.212px)] top-[calc(50%+677.219px)] translate-x-[-50%]" data-name="Story content">
      <TopFrame />
      <BottomFrame />
    </div>
  );
...
function Frame20() {
  return (
    <div className="absolute flex flex-col gap-3 inset-[52.26%_3.83%_14.91%_3.06%] items-start">
      <Frame13 />
      <div className="flex flex-col text-body justify-center leading-[0] min-w-full relative shrink-0 text-body-color w-[min-content]">
...
function UserProfiles() {
  return (
    <div className="absolute flex flex-col gap-6 items-start left-[80px] top-[calc(75%+173.469px)] w-[1209px]" data-name="User profiles">
...
function Frame() {
  return (
    <div className="basis-0 flex gap-3 grow items-center min-h-px min-w-px relative shrink-0">
      <Component26 />
      <p className="[white-space-collapse:collapse] text-body h-[21px] leading-[22px] overflow-ellipsis overflow-hidden relative shrink-0 text-body-color text-nowrap w-[207px]">
        Search Location
      </p>
    </div>
  );
...
function InputArea() {
  return (
    <div className="absolute bg-white inset-0 rounded-[10px]" data-name="Input Area">
      <div className="box-border flex gap-3 items-center overflow-clip px-4 py-3.5 relative rounded-[inherit] size-full">
        <Frame />
        <Component27 />
      </div>
      <div aria-hidden="true" className="absolute border-sub-icons border-[0.5px] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[0px_1px_2px_0px_rgba(228,229,231,0.24)]" />
    </div>
  );
}
...
function SearchLocationField() {
  return (
    <div className="h-[52px] relative shadow-elevation shrink-0 w-[364px]" data-name="search location field">
      <InputArea />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="basis-0 flex gap-3 grow items-center min-h-px min-w-px relative shrink-0">
      <Component28 />
      <p className="text-body leading-[22px] overflow-ellipsis overflow-hidden relative shrink-0 text-body-color text-nowrap whitespace-pre">
        Center Type
      </p>
    </div>
  );
...
function CenterField() {
  return (
    <div className="h-[52px] relative shadow-elevation shrink-0 w-[195px]" data-name="Center field">
      <InputArea1 />
    </div>
  );
}
...
function InputFields() {
  return (
    <div className="flex gap-[25px] items-center relative shrink-0" data-name="Input fields">
      <SearchLocationField />
      <div className="bg-sub-icons h-[44px] shrink-0 w-[3px]" data-name="Divider" />
      <CenterField />
      <div className="bg-sub-icons h-[44px] shrink-0 w-[3px]" data-name="Divider" />
      <PriceField />
    </div>
...
function SearchButton() {
  return (
    <div className="bg-[#5f9ca6] box-border flex gap-[7.998px] items-center justify-center p-3 relative rounded-[50px] shadow-elevation shrink-0" data-name="search button">
      <Component30 />
    </div>
  );
}
...
function HelpCenterFinder() {
  return (
    <div className="absolute box-border flex flex-col gap-[21px] h-[236px] items-center left-[127px] px-[8px] py-0 top-[calc(25%+1000.25px)]" data-name="Help center finder">
      <TitleAndDescription />
      <InputFields1 />
    </div>
  );
...
function Profile() {
  return (
    <div className="flex flex-col gap-[4px] h-[50px] items-center relative shrink-0 w-[45px]" data-name="Profile">
      <Component31 />
      <div className="flex flex-col text-body justify-center leading-[0] min-w-full relative shrink-0 text-sub-icons text-center w-[min-content]">
...
function Frame24() {
  return (
    <div className="flex flex-col gap-[4px] h-[50px] items-center relative shrink-0 w-[72px]">
...
function Frame25() {
  return (
    <div className="flex flex-col gap-[4px] h-[50px] items-center justify-center relative shrink-0 w-[61px]">
      <Component32 />
      <div className="flex flex-col text-body justify-center leading-[0] min-w-full relative shrink-0 text-sub-icons text-center w-[min-content]">
...
function Frame26() {
  return (
    <div className="flex flex-col gap-[4px] h-[50px] items-center justify-center relative shrink-0 w-[74px]">
      <Component33 />
      <div className="flex flex-col text-body justify-center leading-[0] min-w-full relative shrink-0 text-sub-icons text-center w-[min-content]">
...
function Frame29() {
  return (
    <div className="flex gap-[138px] items-center relative shrink-0">
      <Frame28 />
      <Logo />
    </div>
  );
...
function Tutorial() {
  return (
    <div className="flex flex-col gap-[4px] h-[50px] items-center relative shrink-0 w-[72px]" data-name="tutorial">
      <MaterialSymbolsHelp />
      <div className="flex flex-col text-body justify-center leading-[0] min-w-full relative shrink-0 text-sub-icons text-center w-[min-content]">
...
function Group3() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col text-label h-[23.256px] justify-center leading-[0] ml-[21.392px] mt-[21.47px] relative text-secondary text-center translate-x-[-50%] translate-y-[-50%] w-[20.784px]">
...
function Group4() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] flex flex-col font-['Roboto:Bold',_'Noto_Sans_Devanagari:Bold',_sans-serif] font-bold h-[18.605px] justify-center leading-[0] ml-[21.333px] mt-[21.47px] relative text-disabled-primary text-[16px] text-center translate-x-[-50%] translate-y-[-50%] w-[42.667px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Component35() {
  return (
    <div className="bg-secondary box-border flex gap-[4px] h-[50px] items-center leading-[0] p-[4px] relative rounded-[25px] shrink-0" data-name="Component 56">
      <Group3 />
      <Group4 />
    </div>
  );
...
function Frame27() {
  return (
    <div className="flex gap-6 items-center justify-center relative shrink-0">
      <Tutorial />
      <Component35 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="absolute flex items-center justify-between left-[31px] top-[11px] w-[962.333px]">
      <Frame29 />
      <Frame27 />
    </div>
  );
...
function NavigationBar() {
  return (
    <div className="absolute bg-white h-[72px] left-[calc(50%-0.5px)] overflow-clip rounded-[50px] shadow-elevation top-[40px] translate-x-[-50%] w-[1025px]" data-name="Navigation Bar">
      <Frame30 />
    </div>
  );
}
