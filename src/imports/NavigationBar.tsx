import svgPaths from "./svg-eya6yujxnj";
...
export default function NavigationBar() {
  return (
    <div className="bg-white overflow-clip relative rounded-[50px] shadow-[0px_0px_10px_0px_#dddddd] size-full" data-name="Navigation Bar">
      <Frame6 />
    </div>
  );
}