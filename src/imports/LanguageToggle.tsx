function LanguageEnglish() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Language=English">
...
function LanguageHindiStateInactive() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Language=Hindi, State=Inactive">
      <div className="[grid-area:1_/_1] h-[42.857px] ml-0 mt-0 relative w-[42.667px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 43">
